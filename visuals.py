...
from sklearn.model_selection import validation_curve as v_curve
...
def ModelComplexity(X, y):
    ...
    train_scores, test_scores = v_curve(DecisionTreeRegressor(), X, y, param_name = "max_depth", param_range = max_depth, cv = cv, scoring = 'r2')
